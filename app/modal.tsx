...
import { Platform, StyleSheet, View, Text, Button, TextInput, Linking, Keyboard, ImageBackground, Pressable, TouchableWithoutFeedback } from 'react-native';
...
export default function ModalScreen() {
  ...
  return (
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      <SafeAreaView className="w-[90%] self-center">
        ...
        <Pressable 
          className='self-center rounded-md h-10 w-48 bg-black border-2'
